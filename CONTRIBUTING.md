...
1. To begin, [fork this project], clone your fork, and add our upstream.
   ...
   git clone https://github.com/<your-username>/runtime-bundler
   # Navigate to the newly cloned directory
   cd runtime-bundler
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/maoberlehner/runtime-bundler
...
[already been reported]: https://github.com/maoberlehner/runtime-bundler/issues
[fork this project]:     https://github.com/maoberlehner/runtime-bundler/fork
